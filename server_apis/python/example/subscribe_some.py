...
def on_message(channel, method_frame, header_frame, body):
    try:
        ...
        # need to make sure we ack the messages so they don't get left
        # un-acked in the queue
...
def build_cli_parser():
    ...
    parser.add_option("-p", "--password", action="store", default=None,
                      dest="password",
...
if __name__ == "__main__":
    ...
    # build the command line parser and ensure that the required password
    # option was provided
    #
